"""
Clone a target library and copy reference source + raw tests for yoink replacement.
...
REFERENCE_DIR = Path(".yoink/reference")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prepare yoink environment")
